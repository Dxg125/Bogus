#### THANKS TO https://github.com/PowerShell/PowerShell/blob/master/tools/install-powershell.ps1
# https://superuser.com/questions/1625875/is-there-any-built-in-self-upgrade-command-for-upgrading-in-powershell-7-x
