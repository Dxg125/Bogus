 ...
 *
 *
 * this has been copy pasta ed from
 * https://github.com/newelski/cross-browser-audio-volume/blob/main/src/CrossBrowserAudioVolume.js
 * 
 */
...
const volumeControl = new CrossBrowserAudioVolume(SOUND, {
 initialVolume  : 10,
 debug          : true,
 onVolumeChange : (volume) => {console.log(`Volume changed to ${volume}%`);},
 onReady        : () => {console.log('Audio system ready');},
